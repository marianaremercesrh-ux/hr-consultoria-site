...
import { AdminNotice, AdminSkeleton, adminInputClass, adminTableHeadClass, adminTableRowClass } from "../components/AdminUI";
...
export default function AdminProcessesPage() {
  ...
  return <main className="min-h-screen bg-[#F5F7FA]"><AdminNav/><section className="mx-auto max-w-7xl px-5 py-10"><h1 className="text-3xl font-semibold text-[#052656]">Processos seletivos</h1>{message && <AdminNotice>{message}</AdminNotice>}
