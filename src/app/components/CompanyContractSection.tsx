...
export default function CompanyContractSection({ empresaId }: { empresaId: string }) {
  ...
  async function saveRelease() {
    ...
    try {
      ...
      setContract(updated);
      setRelease(updated.portal_liberado);
      setContractStatus(updated.status_contrato);
      setIsEditingRelease(false);
